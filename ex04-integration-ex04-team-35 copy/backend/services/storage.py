...
class StorageService:
    ...
    def delete_user(self, pid: int) -> str:
        """Delete a user and their check-ins based on the provided PID.

        Args:
            pid: The PID of the user to be deleted.

        Returns:
            A message indicating the operation's status.

        Raises:
            Exception if the user with the PID does not exist.
        """
        global _registrations, _checkins
        ...
        return "User and associated check-ins deleted successfully."